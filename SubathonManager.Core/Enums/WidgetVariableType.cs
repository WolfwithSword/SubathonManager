...
public static class WidgetVariableTypeHelper {
    ...
    public static bool IsFontVariable(this WidgetVariableType type) {
        return FontVariables.Contains(type);
    }

    public static bool IsFileVariable(this WidgetVariableType? varType) {
        return varType.HasValue && FileVariables.Contains(varType.Value);
    }

    public static bool IsEnumVariable(this WidgetVariableType? varType) {
        return varType.HasValue && GetClsSingleType(varType.Value).IsEnum;
    }

    public static List<SubathonEventType> GetFilteredEventTypes(this WidgetVariableType varType) {
    ...
    public static bool IsListType(this WidgetVariableType varType) {
        return varType switch {
    ...
    public static Type GetClsSingleType(this WidgetVariableType varType) {
        return varType switch {
...
public static class WidgetCssVariableTypeHelper {
    public static List<string> GetOptions(this WidgetCssVariableType varType) {
        return varType switch {
            WidgetCssVariableType.Alignment => ["left", "center", "right"],
            WidgetCssVariableType.Size =>
                ["px", "%", "pt", "rem", "em", "vh", "vw", "vmin", "vmax", "cm", "mm", "in", "ch", "ex"],
            WidgetCssVariableType.Weight => [
