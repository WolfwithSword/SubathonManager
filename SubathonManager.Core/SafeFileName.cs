...
public static class SafeFileName {
    ...
    private static HashSet<char> BuildInvalidChars() {
        ...
        for (var c = (char)0; c <= (char)31; c++) chars.Add(c);
        chars.Add((char)127);
    ...
    public static bool IsInvalidChar(char value) {
        return InvalidChars.Contains(value);
    }

    public static bool IsSafe([NotNullWhen(true)] string? value) {
        return !string.IsNullOrWhiteSpace(value) && string.Equals(Sanitize(value), value, StringComparison.Ordinal);
    }
