...
public static class NumericInputBehaviour {
    ...
    public static void SetMode(TextBox element, NumericMode value) {
        element.SetValue(ModeProperty, value);
    }

    public static NumericMode GetMode(TextBox element) {
    ...
    private static void OnTextChanged(object? sender, TextChangedEventArgs e) {
        ...
        string previous = LastValid.TryGetValue(tb, out string? v) ? v : string.Empty;
    ...
    private static bool IsAcceptable(string text, NumericMode mode) {
        ...
        NumberStyles intStyles = allowSign ? NumberStyles.AllowLeadingSign : NumberStyles.None;
