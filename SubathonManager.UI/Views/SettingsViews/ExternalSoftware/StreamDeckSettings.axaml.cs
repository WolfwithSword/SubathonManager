...
public partial class StreamDeckSettings : SettingsControl {
    ...
    private void OpenStreamDeckSetup_Click(object? sender, RoutedEventArgs e) {
        OpenDocs();
    }
    ...
    private void DownloadPlugin_Click(object? sender, RoutedEventArgs e) {
        ...
        var url =
            $"https://github.com/WolfwithSword/SubathonManager/releases/download/{version}/SubathonManager_StreamDeck.streamDeckPlugin";
        try {
            Process.Start(new ProcessStartInfo {
                FileName = url,
                UseShellExecute = true
