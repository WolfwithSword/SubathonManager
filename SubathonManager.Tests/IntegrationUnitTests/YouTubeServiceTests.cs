...
public class YouTubeServiceTests {
    ...
    public void SimulateSuperChat_ShouldRaiseEvent() {
        SubathonEvent? captured = CaptureEvent(() => YouTubeService.SimulateSuperChat("12.5"));
    ...
    public void OnInitialPageLoaded_ShouldSetRunningTrueAndRaiseEvent() {
        ...
        var httpLogger = new Mock<ILogger<YTHttpClient>>();
        ...
        try {
            MethodInfo? method = typeof(YouTubeService)
    ...
    public void OnChatReceived_ShouldRaiseSuperChatEvent() {
        ...
        FieldInfo? field = typeof(YouTubeService)
    ...
    public void OnChatReceived_ChatCommand_InvokesCommandService() {
        ...
        IConfig configCs = MockConfig.MakeMockConfig(new Dictionary<(string, string), string> {
    ...
    public void SimulateSuperChat_ShouldNotRaiseEvent_WhenValueInvalid() {
        ...
        YouTubeService.SimulateSuperChat("notanumber");
    ...
    public void OnChatReceived_ShouldReturnEarly_WhenHandleIsEmpty() {
        ...
        var chatItem = new ChatItem {
            ...
            Message = [],
            Superchat = new Superchat {
                AmountString = "$5.00", AmountValue = 5, Currency = "USD",
                BodyBackgroundColor = ""
            }
        };
    ...
    public void OnChatReceived_ShouldRaiseConnectionUpdate_WhenNotRunning() {
        ...
        var connectionEventRaised = false;

        Action<IntegrationConnection> handler = conn => {
            if (conn is { Source: SubathonEventSource.YouTube }) connectionEventRaised = true;
        };
        IntegrationEvents.ConnectionUpdated += handler;
    ...
    [InlineData(MembershipEventType.Unknown, "Gold", "Some subtext", SubathonEventType.YouTubeMembership,
        "Some subtext")] // not true case
    [InlineData(MembershipEventType.Unknown, "Gold", "Welcome new member!", SubathonEventType.YouTubeMembership,
        "Gold")]
    [InlineData(MembershipEventType.Unknown, "Upgraded membership to MyTier!!", "Upgraded membership to MyTier!!",
        SubathonEventType.YouTubeMembership, "MyTier!")]
    ...
    public void TryReconnectLoop_ShouldNotStart_WhenHandleIsEmpty() {
        ...
        Exception? ex = Record.Exception(() => method!.Invoke(service, null));
        Assert.Null(ex);
    }
