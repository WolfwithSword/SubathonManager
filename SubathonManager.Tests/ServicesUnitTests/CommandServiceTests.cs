...
public class CommandServiceTests {
    ...
    private static void SetupServices() {
        ...
        CurrencyService currencyMock = CreateCurrencyService(fakeJson);
    ...
    private static IConfig MockConfig(Dictionary<(string, string), string>? values = null) {
        ...
        foreach (string cmd in Enum.GetNames<SubathonCommandType>()) {
            ...
            var kd = new KeyData($"Commands.{cmd}.name");
            kd.Value = cmd.ToLower();
            keyData.AddKey(kd);

            var kd2 = new KeyData($"Commands.{cmd}.permissions.Mods");
            kd2.Value = "True";
            keyData.AddKey(kd2);

            var kd3 = new KeyData($"Commands.{cmd}.permissions.VIPs");
            kd3.Value = "False";
            keyData.AddKey(kd3);

            var kd4 = new KeyData($"Commands.{cmd}.permissions.Whitelist");
    ...
    [InlineData("subtractmoney", "50.77 AUD", false, false, false, "speciallittleguy", SubathonEventSource.Twitch,
        true)]
    public void IsValidCommand_Works_HappyPaths(string? command, string? message, bool isBroadcaster,
        ...
        bool outcome = CommandService.ChatCommandRequest(source ?? SubathonEventSource.Unknown,
    ...
    [InlineData("setpoints", "what's a mustard", false, false, false, "speciallittleguy", SubathonEventSource.Twitch,
        false)]
    ...
    [InlineData("setmultiplier", "2x 1h", false, true, false, "John", SubathonEventSource.Twitch,
        true)] // isValid but throws stopmult
    [InlineData("setmultiplier", "pt", true, false, false, "John", SubathonEventSource.Twitch,
        true)] // isValid but throws stopmult
    [InlineData("setmultiplier", "3t 5h", false, false, false, "speciallittleguy", SubathonEventSource.Twitch,
        true)] // isValid but throws stopmult
    ...
    [InlineData("addmoney", "50 cheeseburger", false, false, false, "speciallittleguy", SubathonEventSource.Twitch,
        false)]
